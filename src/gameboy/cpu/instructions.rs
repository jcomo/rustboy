...
fn execute_extended(op: u8, cpu: &mut CPU, memory: &mut MemoryBus) {
    ...
    match op {
        ...
        0x41 => bit(cpu, memory, C, 0),
        0x42 => bit(cpu, memory, D, 0),
        0x43 => bit(cpu, memory, E, 0),
        0x44 => bit(cpu, memory, H, 0),
        0x45 => bit(cpu, memory, L, 0),
        0x46 => bit(cpu, memory, AddrHL, 0),
        0x47 => bit(cpu, memory, A, 0),
        0x48 => bit(cpu, memory, B, 1),
        0x49 => bit(cpu, memory, C, 1),
        0x4A => bit(cpu, memory, D, 1),
        0x4B => bit(cpu, memory, E, 1),
        0x4C => bit(cpu, memory, H, 1),
        0x4D => bit(cpu, memory, L, 1),
        0x4E => bit(cpu, memory, AddrHL, 1),
        0x4F => bit(cpu, memory, A, 1),
        0x50 => bit(cpu, memory, B, 2),
        0x51 => bit(cpu, memory, C, 2),
        0x52 => bit(cpu, memory, D, 2),
        0x53 => bit(cpu, memory, E, 2),
        0x54 => bit(cpu, memory, H, 2),
        0x55 => bit(cpu, memory, L, 2),
        0x56 => bit(cpu, memory, AddrHL, 2),
        0x57 => bit(cpu, memory, A, 2),
        0x58 => bit(cpu, memory, B, 3),
        0x59 => bit(cpu, memory, C, 3),
        0x5A => bit(cpu, memory, D, 3),
        0x5B => bit(cpu, memory, E, 3),
        0x5C => bit(cpu, memory, H, 3),
        0x5D => bit(cpu, memory, L, 3),
        0x5E => bit(cpu, memory, AddrHL, 3),
        0x5F => bit(cpu, memory, A, 3),
        0x60 => bit(cpu, memory, B, 4),
        0x61 => bit(cpu, memory, C, 4),
        0x62 => bit(cpu, memory, D, 4),
        0x63 => bit(cpu, memory, E, 4),
        0x64 => bit(cpu, memory, H, 4),
        0x65 => bit(cpu, memory, L, 4),
        0x66 => bit(cpu, memory, AddrHL, 4),
        0x67 => bit(cpu, memory, A, 4),
        0x68 => bit(cpu, memory, B, 5),
        0x69 => bit(cpu, memory, C, 5),
        0x6A => bit(cpu, memory, D, 5),
        0x6B => bit(cpu, memory, E, 5),
        0x6C => bit(cpu, memory, H, 5),
        0x6D => bit(cpu, memory, L, 5),
        0x6E => bit(cpu, memory, AddrHL, 5),
        0x6F => bit(cpu, memory, A, 5),
        0x70 => bit(cpu, memory, B, 6),
        0x71 => bit(cpu, memory, C, 6),
        0x72 => bit(cpu, memory, D, 6),
        0x73 => bit(cpu, memory, E, 6),
        0x74 => bit(cpu, memory, H, 6),
        0x75 => bit(cpu, memory, L, 6),
        0x76 => bit(cpu, memory, AddrHL, 6),
        0x77 => bit(cpu, memory, A, 6),
        0x78 => bit(cpu, memory, B, 7),
        0x79 => bit(cpu, memory, C, 7),
        0x7A => bit(cpu, memory, D, 7),
        0x7B => bit(cpu, memory, E, 7),
        0x7C => bit(cpu, memory, H, 7),
        0x7D => bit(cpu, memory, L, 7),
        0x7E => bit(cpu, memory, AddrHL, 7),
        0x7F => bit(cpu, memory, A, 7),
        0x80 => res(cpu, memory, B, 0),
        0x81 => res(cpu, memory, C, 0),
        0x82 => res(cpu, memory, D, 0),
        0x83 => res(cpu, memory, E, 0),
        0x84 => res(cpu, memory, H, 0),
        0x85 => res(cpu, memory, L, 0),
        0x86 => res(cpu, memory, AddrHL, 0),
        0x87 => res(cpu, memory, A, 0),
        0x88 => res(cpu, memory, B, 1),
        0x89 => res(cpu, memory, C, 1),
        0x8A => res(cpu, memory, D, 1),
        0x8B => res(cpu, memory, E, 1),
        0x8C => res(cpu, memory, H, 1),
        0x8D => res(cpu, memory, L, 1),
        0x8E => res(cpu, memory, AddrHL, 1),
        0x8F => res(cpu, memory, A, 1),
        0x90 => res(cpu, memory, B, 2),
        0x91 => res(cpu, memory, C, 2),
        0x92 => res(cpu, memory, D, 2),
        0x93 => res(cpu, memory, E, 2),
        0x94 => res(cpu, memory, H, 2),
        0x95 => res(cpu, memory, L, 2),
        0x96 => res(cpu, memory, AddrHL, 2),
        0x97 => res(cpu, memory, A, 2),
        0x98 => res(cpu, memory, B, 3),
        0x99 => res(cpu, memory, C, 3),
        0x9A => res(cpu, memory, D, 3),
        0x9B => res(cpu, memory, E, 3),
        0x9C => res(cpu, memory, H, 3),
        0x9D => res(cpu, memory, L, 3),
        0x9E => res(cpu, memory, AddrHL, 3),
        0x9F => res(cpu, memory, A, 3),
        0xA0 => res(cpu, memory, B, 4),
        0xA1 => res(cpu, memory, C, 4),
        0xA2 => res(cpu, memory, D, 4),
        0xA3 => res(cpu, memory, E, 4),
        0xA4 => res(cpu, memory, H, 4),
        0xA5 => res(cpu, memory, L, 4),
        0xA6 => res(cpu, memory, AddrHL, 4),
        0xA7 => res(cpu, memory, A, 4),
        0xA8 => res(cpu, memory, B, 5),
        0xA9 => res(cpu, memory, C, 5),
        0xAA => res(cpu, memory, D, 5),
        0xAB => res(cpu, memory, E, 5),
        0xAC => res(cpu, memory, H, 5),
        0xAD => res(cpu, memory, L, 5),
        0xAE => res(cpu, memory, AddrHL, 5),
        0xAF => res(cpu, memory, A, 5),
        0xB0 => res(cpu, memory, B, 6),
        0xB1 => res(cpu, memory, C, 6),
        0xB2 => res(cpu, memory, D, 6),
        0xB3 => res(cpu, memory, E, 6),
        0xB4 => res(cpu, memory, H, 6),
        0xB5 => res(cpu, memory, L, 6),
        0xB6 => res(cpu, memory, AddrHL, 6),
        0xB7 => res(cpu, memory, A, 6),
        0xB8 => res(cpu, memory, B, 7),
        0xB9 => res(cpu, memory, C, 7),
        0xBA => res(cpu, memory, D, 7),
        0xBB => res(cpu, memory, E, 7),
        0xBC => res(cpu, memory, H, 7),
        0xBD => res(cpu, memory, L, 7),
        0xBE => res(cpu, memory, AddrHL, 7),
        0xBF => res(cpu, memory, A, 7),
        0xC0 => set(cpu, memory, B, 0),
        0xC1 => set(cpu, memory, C, 0),
        0xC2 => set(cpu, memory, D, 0),
        0xC3 => set(cpu, memory, E, 0),
        0xC4 => set(cpu, memory, H, 0),
        0xC5 => set(cpu, memory, L, 0),
        0xC6 => set(cpu, memory, AddrHL, 0),
        0xC7 => set(cpu, memory, A, 0),
        0xC8 => set(cpu, memory, B, 1),
        0xC9 => set(cpu, memory, C, 1),
        0xCA => set(cpu, memory, D, 1),
        0xCB => set(cpu, memory, E, 1),
        0xCC => set(cpu, memory, H, 1),
        0xCD => set(cpu, memory, L, 1),
        0xCE => set(cpu, memory, AddrHL, 1),
        0xCF => set(cpu, memory, A, 1),
        0xD0 => set(cpu, memory, B, 2),
        0xD1 => set(cpu, memory, C, 2),
        0xD2 => set(cpu, memory, D, 2),
        0xD3 => set(cpu, memory, E, 2),
        0xD4 => set(cpu, memory, H, 2),
        0xD5 => set(cpu, memory, L, 2),
        0xD6 => set(cpu, memory, AddrHL, 2),
        0xD7 => set(cpu, memory, A, 2),
        0xD8 => set(cpu, memory, B, 3),
        0xD9 => set(cpu, memory, C, 3),
        0xDA => set(cpu, memory, D, 3),
        0xDB => set(cpu, memory, E, 3),
        0xDC => set(cpu, memory, H, 3),
        0xDD => set(cpu, memory, L, 3),
        0xDE => set(cpu, memory, AddrHL, 3),
        0xDF => set(cpu, memory, A, 3),
        0xE0 => set(cpu, memory, B, 4),
        0xE1 => set(cpu, memory, C, 4),
        0xE2 => set(cpu, memory, D, 4),
        0xE3 => set(cpu, memory, E, 4),
        0xE4 => set(cpu, memory, H, 4),
        0xE5 => set(cpu, memory, L, 4),
        0xE6 => set(cpu, memory, AddrHL, 4),
        0xE7 => set(cpu, memory, A, 4),
        0xE8 => set(cpu, memory, B, 5),
        0xE9 => set(cpu, memory, C, 5),
        0xEA => set(cpu, memory, D, 5),
        0xEB => set(cpu, memory, E, 5),
        0xEC => set(cpu, memory, H, 5),
        0xED => set(cpu, memory, L, 5),
        0xEE => set(cpu, memory, AddrHL, 5),
        0xEF => set(cpu, memory, A, 5),
        0xF0 => set(cpu, memory, B, 6),
        0xF1 => set(cpu, memory, C, 6),
        0xF2 => set(cpu, memory, D, 6),
        0xF3 => set(cpu, memory, E, 6),
        0xF4 => set(cpu, memory, H, 6),
        0xF5 => set(cpu, memory, L, 6),
        0xF6 => set(cpu, memory, AddrHL, 6),
        0xF7 => set(cpu, memory, A, 6),
        0xF8 => set(cpu, memory, B, 7),
        0xF9 => set(cpu, memory, C, 7),
        0xFA => set(cpu, memory, D, 7),
        0xFB => set(cpu, memory, E, 7),
        0xFC => set(cpu, memory, H, 7),
        0xFD => set(cpu, memory, L, 7),
        0xFE => set(cpu, memory, AddrHL, 7),
